...
export PATH=$PATH:/mnt/c/buildto/bin
...
# Assemble 1and write bootloader.
...
export CFLAGS="-B/mnt/c/buildto/bin/i686-elf- -std=gnu99 -ffreestanding -Wall -Wextra -g"
